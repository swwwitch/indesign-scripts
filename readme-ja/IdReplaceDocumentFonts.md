...
ドキュメントで使用中のフォントをファミリー／スタイル単位で一覧し、選んだフォントを別のフォントへまとめて置き換えます。段落スタイル・文字スタイルのフォントも同時に更新できます。
...
- ［段落・文字スタイルも更新］（初期状態はオン）で、テキストだけでなく段落スタイル・文字スタイルのフォントも置き換え
...
- ［段落・文字スタイルも更新］をオフにして置換すると、テキストにはオーバーライドがかかり、段落スタイルを再適用すると元のフォントに戻ります。
