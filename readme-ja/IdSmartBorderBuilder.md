...
- モードは「すべて／外枠のみ／内側のみ／水平線のみ／垂直線のみ／下端のみ／右端のみ／見出し行／見出し列／左右の外枠を消去／すべて消去」
...
- 表の一部を選択した場合も、選択範囲の矩形からセルを再構築して処理します。矩形に一部でも掛かる結合セルも対象に含めます。
- 「既存の罫線を消してから引く」を OFF にすると既存の罫線を残したまま上書きできます。
...
| 初回リリース | 2026-04-11 |
| 最終更新 | 2026-09-15 |
| 紹介記事 | https://note.com/dtp_tranist/n/n8c1bcb9a2844 |
