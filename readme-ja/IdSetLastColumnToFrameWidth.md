...
[![English](https://img.shields.io/badge/README-English-4b8bbe.svg)](https://github.com/swwwitch/indesign-scripts/blob/main/readme-en/IdSetLastColumnToFrameWidth.md)
...
| 項目 | 内容 |
| --- | --- |
| ファイル | `jsx/table/IdSetLastColumnToFrameWidth.jsx` |
| バージョン | v1.0.0 |
