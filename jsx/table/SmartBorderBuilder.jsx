 ...
 * - モード切り替え用ショートカットキー対応（A/E/I/H/V/B/U/L/R/C）
 ...
 * - 日本語／英語UI対応
 * - 前回OKで確定した設定を記憶し、次回起動時に復元（キャンセル時やエラー時は保存しません）
 */

var SCRIPT_VERSION = "v1.6.7";
...
var LABELS = {
    ...
    stylePanel: { ja: "スタイル", en: "Border Style" },
    ...
    tipAll: { ja: "ショートカット: A / Option+クリックで消去ON/OFF", en: "Shortcut: A / Option-click toggles Clear Existing Borders" },
    tipOuter: { ja: "ショートカット: E / Option+クリックで消去ON/OFF", en: "Shortcut: E / Option-click toggles Clear Existing Borders" },
    tipInner: { ja: "ショートカット: I / Option+クリックで消去ON/OFF", en: "Shortcut: I / Option-click toggles Clear Existing Borders" },
    tipHorizontal: { ja: "ショートカット: H / Option+クリックで消去ON/OFF", en: "Shortcut: H / Option-click toggles Clear Existing Borders" },
    tipVertical: { ja: "ショートカット: V / Option+クリックで消去ON/OFF", en: "Shortcut: V / Option-click toggles Clear Existing Borders" },
    tipBottomOnly: { ja: "ショートカット: B / Option+クリックで消去ON/OFF", en: "Shortcut: B / Option-click toggles Clear Existing Borders" },
    tipRightOnly: { ja: "Option+クリックで消去ON/OFF", en: "Option-click toggles Clear Existing Borders" },
    tipHeaderRow: { ja: "ショートカット: U / Option+クリックで消去ON/OFF", en: "Shortcut: U / Option-click toggles Clear Existing Borders" },
    tipHeaderColumn: { ja: "ショートカット: L / Option+クリックで消去ON/OFF", en: "Shortcut: L / Option-click toggles Clear Existing Borders" },
    tipClearLeftRight: { ja: "ショートカット: R / Option+クリックで消去ON/OFF", en: "Shortcut: R / Option-click toggles Clear Existing Borders" },
    tipAllOff: { ja: "ショートカット: C / Option+クリックで消去ON/OFF", en: "Shortcut: C / Option-click toggles Clear Existing Borders" }
};
...
(function () {
    ...
    function buildDialog() {
        ...
        var rbBottomOnly = panelMode.add("radiobutton", undefined, L('bottomOnly'));
        rbBottomOnly.helpTip = L('tipBottomOnly');
        var rbRightOnly = panelMode.add("radiobutton", undefined, L('rightOnly'));
        rbRightOnly.helpTip = L('tipRightOnly');
        ...
        var rbWeightNone = weightPresetGroup.add("radiobutton", undefined, L('weightNone'));
